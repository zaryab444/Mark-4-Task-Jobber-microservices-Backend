...
import { BadRequestError } from '@order/middlewares/error-handler';
...
//this method used in checkout form where you enter card number cvv and click pay so your information go to stripe
...
// this method just only order requirements

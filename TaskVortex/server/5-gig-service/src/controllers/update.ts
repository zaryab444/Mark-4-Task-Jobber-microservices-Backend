import { ISellerGig } from '@gig/interfaces/gig.interface';
import { uploads } from '@gig/middlewares/cloudinary-upload';
import { BadRequestError } from '@gig/middlewares/error-handler';
import { isDataURL } from '@gig/middlewares/helpers';

...
async function consumeAuthEmailMessages(channel: Channel): Promise<void> {
  try {
    ...
    channel.consume(jobberQueue.queue, async (msg: ConsumeMessage | null) => {
      ...
      const locals = {
        appLink: `${config.CLIENT_URL}`, //this is for frontend client url like angular or react
    ...
    console.log('error', 'NotificationService EmailConsumer consumeAuthEmailMessages() method error:', error);
  }
}

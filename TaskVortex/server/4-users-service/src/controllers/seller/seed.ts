...
import { IBuyerDocument } from '@users/interface/buyer.interface';
import { IEducation, IExperience, ISellerDocument } from '@users/interface/seller.interface';
import { BadRequestError } from '@users/middlewares/error-handler';
